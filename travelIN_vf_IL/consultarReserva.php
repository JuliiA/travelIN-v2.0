												...
												<div class="col-md-8" id="agrupFormPublic" name="agrupFormPublic">
													<form class="form-horizontal" name="reserva" id="reserva" action="consultarReserva.php" method="post" enctype="multipart/form-data">
														...
														<div class="pull-centro col-md-9">
															<label></label>
															<input class="btn btn-lg" type="submit" id="consultar" name="consultar" value="Consultar"/>
															<input class="btn-grey btn-lg" type="reset" id="cancelar" name="cancelar" value="Cancelar"/>
														</div>
													</form>
												</div>
											</div>
