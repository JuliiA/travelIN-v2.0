...
<head>
	<?php
		...
		$sqlGaleria0 = 'SELECT nombre FROM establecimiento 
						WHERE MD5(concat("nvw42rbhfbhrefb3i34",idEstableci)) ="'.$idEstableci.'" AND idEstado = 2';
...
-->
														...
														<?php
															$sqlFotos1 = 'SELECT * FROM fotoEstableci WHERE MD5(concat("nvw42rbhfbhrefb3i34",idEstableci)) ="'.$idEstableci.'"';
