...
class reservacion
{
	function tieneEstablecimiento($ide)
	{
		$sqlDesc0 = sprintf('SELECT idEstableci, descripcion FROM establecimiento WHERE idUsuario='.$ide.' AND idEstado = 2');
		return $this->ejecutarConsultaDevolviendoResult($sqlDesc0);
	}
