...
class disponibilidad
{
	...
	function existenDisponibles($idestablecimiento)
	{
		...
		$con = new Conexion();
		$sql = sprintf('SELECT d.idDisponibilidad as dis,d.idHabitacion as habi,d.periodoDesde as desde,d.periodoHasta as hasta FROM disponibilidad d inner join habitacion h on d.idHabitacion = h.idHabitacion WHERE MD5(concat("nvw42rbhfbhrefb3i34",d.idEstableci))="'.$idestablecimiento.'"');
