...
SI recibo por parametro GET = "DO" es que soy un dueño y quiero dejar sentada un reserva con fecha desde-hasta, habitacion y mail 
...
EL DUEÑO VE EL MAIL DE CONFIRMACION Y PUEDE CAMBIAR EL ESTADO DE LA RESERVA EN RESERVACION.PHP DONDE SE LISTAN TODOS LAS RESERVAS EN CUALQUIER ESTADO 
*/
//include('head.php');
session_start();
									...
									<div class="navbar navbar-default" role="navigation">
										...
										<div class="navbar-collapse collapse sidebar-navbar-collapse">
											<ul class="nav navbar-nav" id="sidenav01">
												...
												<li><a href="publicacion.php"><span class="glyphicon glyphicon-lock"></span> Mí publicacion </a></li>
												<li>
